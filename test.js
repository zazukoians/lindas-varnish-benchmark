...
const queries = [
  `
    ...
    SELECT DISTINCT ?dimension0 ?dimension1 ?dimension2 ?dimension3 ?dimension4 ?dimension5 ?dimension6 ?dimension7 ?dimension8 ?dimension9 WHERE {
      ...
      ?source0 <https://energy.ld.admin.ch/elcom/electricityprice/dimension/period> ?dimension3 .
      ?source0 <https://energy.ld.admin.ch/elcom/electricityprice/dimension/aidfee> ?dimension4 .
      ?source0 <https://energy.ld.admin.ch/elcom/electricityprice/dimension/product> ?dimension5 .
      FILTER (
        (?dimension0 = <https://energy.ld.admin.ch/elcom/electricityprice/category/C1>)
      )
      FILTER (
      ...
      FILTER (
        (?dimension5 = <https://energy.ld.admin.ch/elcom/electricityprice/product/standard>)
      )
      OPTIONAL {
      ...
      OPTIONAL {
        ...
        FILTER (
          LANGMATCHES(LANG(?dimension6_1), "fr")
        )
      }
      OPTIONAL {
        ?dimension0 <http://schema.org/name> ?dimension6_2 .
        FILTER (
          LANGMATCHES(LANG(?dimension6_2), "it")
        )
      }
      OPTIONAL {
        ?dimension0 <http://schema.org/name> ?dimension6_3 .
        FILTER (
          LANGMATCHES(LANG(?dimension6_3), "en")
        )
      }
      OPTIONAL {
      ...
      OPTIONAL {
        ...
        FILTER (
          LANGMATCHES(LANG(?dimension9_1), "fr")
        )
      }
      OPTIONAL {
        ?dimension5 <http://schema.org/name> ?dimension9_2 .
        FILTER (
          LANGMATCHES(LANG(?dimension9_2), "it")
        )
      }
      OPTIONAL {
        ?dimension5 <http://schema.org/name> ?dimension9_3 .
        FILTER (
          LANGMATCHES(LANG(?dimension9_3), "en")
        )
      }
      OPTIONAL {
